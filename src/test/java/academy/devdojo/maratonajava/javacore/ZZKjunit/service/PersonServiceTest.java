...
class PersonServiceTest {
    ...
    void isAdult_ReturnFalse_WhenAgeIsGreaterOrEqualrThan18() {
    ...
    void filterRemovingNotAdults_Return_WhenListOfPersonWithAdultIsPassed() {
        Person person1 = new Person(17);
        Person person2 = new Person(18);
        Person person3 = new Person(21);
        List<Person> personList = List.of(person3, person1, person2);
